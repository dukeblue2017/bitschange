    ...
    return (
      <div className="buy">
        <form className="buy-form" onSubmit={this.handleSubmit}>
          ...
          <div>Estimated Cost: {this.state.coinSelection === 'BTC' ? (this.state.estimatedCost.toFixed(2) * 1).toLocaleString() : this.state.estimatedCost} {this.props.prices && this.props.prices[this.state.coinSelection].denominator}</div>
      </div>
    );
  }
}
